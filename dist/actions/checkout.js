...
const ADD_TO_CART_SELECTOR = "#mbc-addtocart-div-1 span#mbc-buybutton-addtocart-1";
...
class Checkout {
    ...
    addToCart() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.page.waitForSelector(ADD_TO_CART_WAIT_SELECTOR);
    ...
    checkout() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.page.waitForSelector(CHECKOUT_WAIT_SELECTOR);
